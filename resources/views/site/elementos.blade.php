                ...
                <div class="col-12 h-100">
                    <div class="main-menu h-100">
                        <nav class="navbar h-100 navbar-expand-lg">
                            <!-- Logo Area  -->
                            <a class="navbar-brand" href="index.html"><img src="./site/img/core-img/logo.png" alt="Logo"></a>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    ...
                    <div class="studio-buttons-area mb-100">
                        <a href="#" class="btn studio-btn"><img src="./site/img/core-img/logo-icon.png" alt=""> Send</a>
                        <a href="#" class="btn studio-btn studio-btn-2"><img src="./site/img/core-img/logo-icon-2.png" alt=""> Send</a>
                        <a href="#" class="btn studio-btn studio-btn-3">Send</a>
                        <a href="#" class="btn studio-btn studio-btn-4"><img src="./site/img/core-img/logo-icon-4.png" alt=""> Send</a>
                    </div>
                </div>
                    ...
                    <div class="studio-cool-facts-area mb-100">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact d-flex align-items-center">
                                    <div class="cool-facts-icon mr-3">
                                        <img src="./site/img/core-img/gallery.png" alt="">
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact d-flex align-items-center">
                                    <div class="cool-facts-icon mr-3">
                                        <img src="./site/img/core-img/favorite.png" alt="">
                                    </div>
                                    <div class="counter-area">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact d-flex align-items-center">
                                    <div class="cool-facts-icon mr-3">
                                        <img src="./site/img/core-img/photo-camera-2.png" alt="">
                                    </div>
                                    <div class="counter-area">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact d-flex align-items-center">
                                    <div class="cool-facts-icon mr-3">
                                        <img src="./site/img/core-img/rocket-launch.png" alt="">
                                    </div>
                                    <div class="counter-area">
