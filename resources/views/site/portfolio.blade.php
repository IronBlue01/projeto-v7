...
<body>
    ...
    <!-- Header Area Start -->
    <header class="header-area bg-img" style="background-image: url(./site/img/bg-img/14.jpg);">
        ...
        <div class="container-fluid clearfix">
            ...
            <div class="row portfolio-column">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item portraits life">
                    <img src="./site/img/bg-img/p1.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p1.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item weddings">
                    <img src="./site/img/bg-img/p2.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p2.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item portraits">
                    <img src="./site/img/bg-img/p3.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p3.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item weddings life">
                    <img src="./site/img/bg-img/p4.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p4.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item weddings">
                    <img src="./site/img/bg-img/p5.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p5.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item portraits">
                    <img src="./site/img/bg-img/p6.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p6.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item studio">
                    <img src="./site/img/bg-img/p7.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p7.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item studio life">
                    <img src="./site/img/bg-img/p8.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p8.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item fashion">
                    <img src="./site/img/bg-img/p9.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p9.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item portraits">
                    <img src="./site/img/bg-img/p10.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p10.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item studio life">
                    <img src="./site/img/bg-img/p11.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p11.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>

                <!-- Single Item -->
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item fashion">
                    <img src="./site/img/bg-img/p12.jpg" alt="">
                    <div class="hover_overlay">
                        <a class="gallery_img" href="./site/img/bg-img/p12.jpg"><i class="fa fa-eye"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 text-center mt-70">
                    <a href="#" class="btn studio-btn"><img src="./site/img/core-img/logo-icon.png" alt=""> Load More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <div class="footer-content h-100 d-md-flex align-items-center justify-content-between">
                        ...
                        <!-- Single Footer Content -->
                        <div class="single-footer-content">
                            <img src="./site/img/core-img/smartphone.png" alt="">
