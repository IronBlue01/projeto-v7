...
@section('content')
    ...
    <script
      ...
      defer
    ></script>
    <script src="./dashboard//js/charts-lines.js" defer></script>
    <script src="./dashboard//js/charts-pie.js" defer></script>
    <script src="./dashboard//js/charts-bars.js" defer></script>
