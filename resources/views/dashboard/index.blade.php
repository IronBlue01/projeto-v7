        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              ...
              <div
                @click="openModal"
                class="flex items-center mycard p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800"
              >
                <div
                  class="p-3 mr-4 text-orange-500 bg-red-100 rounded-full dark:text-orange-100 dark:bg-orange-500"
                >
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  @foreach($clientes as $cliente)
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 icone  ml-4 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
